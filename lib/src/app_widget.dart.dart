    ...
    return MaterialApp.router(
      ...
      darkTheme: ThemeData.dark().copyWith(
          ...
          datePickerTheme: DatePickerThemeData(
            ...
            headerHeadlineStyle: GoogleFonts.bebasNeue(fontSize: 45, shadows: [
              Shadow(
                blurRadius: 10, // Define o raio do desfoque da sombra
                color: Colors.black.withOpacity(0.1), // Define a cor da sombra
            ...
            dayOverlayColor: MaterialStateProperty.all(green.withOpacity(0.1)),
            dayStyle: GoogleFonts.poppins(fontSize: 16, shadows: [
              Shadow(
                blurRadius: 10, // Define o raio do desfoque da sombra
                color: Colors.black.withOpacity(0.2), // Define a cor da sombra
          ...
          textTheme: TextTheme(
            ...
            //labels
            labelLarge: GoogleFonts.poppins(fontSize: 24),
            labelMedium: GoogleFonts.poppins(fontSize: 16, color: Colors.white),
            labelSmall: GoogleFonts.poppins(
